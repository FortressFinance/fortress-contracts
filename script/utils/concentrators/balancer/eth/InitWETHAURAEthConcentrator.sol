...
contract InitWETHAURAEthConcentrator is InitBase {
    ...
    function _initWETHAURAEthConcentrator(address _fortressRegistry, address _fortressSwap, address _platform, address _compounder) public returns (address) {
        ...
        BalancerEthConcentrator ETHConcentrator = new BalancerEthConcentrator(ERC20(_asset), _name, _symbol, _platform, address(_fortressSwap), _boosterPoolId, _rewardAssets2, _underlyingAssets2, _compounder);
