...
import "src/concentrators/curve/CurveEthConcentrator.sol";
...
contract InitTricryptoEthConcentrator is InitBase {
    ...
    function _initTricryptoEthConcentrator(address _fortressRegistry, address _fortressSwap, address _platform, address _compounder) public returns (address) {
        ...
        CurveEthConcentrator ethConcentrator = new CurveEthConcentrator(ERC20(_asset), _name, _symbol, _platform, address(_fortressSwap), _boosterPoolId, _rewardAssets2, _underlyingAssets3, _compounder, _poolType);
