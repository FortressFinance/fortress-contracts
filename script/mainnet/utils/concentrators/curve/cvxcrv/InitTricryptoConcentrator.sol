...
// import "src/mainnet/concentrators/curve/CvxCrvConcentrator.sol";
...
contract InitTricryptoConcentrator {}
// contract InitTricryptoConcentrator is InitBase {

//     function _initTricryptoConcentrator(address _owner, address _fortressRegistry, address _fortressSwap, address _platform, address _compounder) public returns (address) {
...
//         CvxCrvConcentrator cvxCrvConcentrator = new CvxCrvConcentrator(ERC20(_asset), _name, _symbol, _owner, _platform, address(_fortressSwap), _boosterPoolId, _rewardAssets2, _underlyingAssets3, _compounder, _poolType);
