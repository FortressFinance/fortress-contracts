...
// contract AddPoolsBalancerCompounder is Addresses {
contract AddPoolsBalancerCompounder{}
//     function addBalancerCompounderPools(address _compounderAddress) public {
...
//         BalancerCompounder _balancerCompounder = BalancerCompounder(_compounderAddress);

//         // ETH/BAL (https://curve.fi/steth)
//         _convexPid = 20;
//         _poolAddress = BALANCER_ETHAURA;
//         _rewardTokens2[0] = BAL;
//         _rewardTokens2[1] = AURA;
    
//         _balancerCompounder.addPool(_convexPid, _poolAddress, _rewardTokens2, _platformFeePercentage, _harvestBountyPercentage, _withdrawFeePercentage);
//     }
// }
