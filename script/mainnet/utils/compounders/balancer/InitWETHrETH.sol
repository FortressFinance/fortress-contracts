...
contract InitWETHrETH {}
// contract InitWETHrETH is InitBase {
    
//     function _initializeWETHrETH(address _owner, address _fortressRegistry, address _fortressSwap, address _platform) public returns (address) {
