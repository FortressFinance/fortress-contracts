...
contract InitAuraBalCompounder {}
// contract InitAuraBalCompounder is InitBase {
    
//     function _initAuraBalCompounder(address _owner, address _fortressRegistry, address _fortressSwap, address _platform) public returns (address) {
...
//         AuraBalCompounder auraBALCompounder = new AuraBalCompounder(_owner, _platform, address(_swap));
