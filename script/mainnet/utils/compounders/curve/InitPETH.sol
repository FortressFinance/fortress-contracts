...
contract InitPETH is InitBase {
    ...
    function _initializePETH(address _owner, address _fortressRegistry, address _fortressSwap, address _platform) public returns (address) {

        _initSwappETH(_fortressSwap);
    ...
    function _initSwappETH(address _fortressSwap) internal {
        // ------------------------- init fortress swap -------------------------
