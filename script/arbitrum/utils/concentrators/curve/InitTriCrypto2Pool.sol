...
import "src/arbitrum/concentrators/curve/TriCryptoTo2Pool.sol";
...
contract InitTriCrypto2Pool is InitBaseArbi {
    
    function _initializeTriCrypto2Pool(address _owner, address _fortressArbiRegistry, address _fortressSwap, address _platform, address _compounder, address _ammOperations) public returns (address) {
        ...
        _asset = TRICRYPTO_LP;
        _symbol = "fctrTriCrypto-fc2Pool";
        _name = "Fortress Curve TriCrypto Concentrating to fc2Pool";
        ...
        TriCryptoTo2Pool triCryptoTo2Pool = new TriCryptoTo2Pool(ERC20(_asset), _name, _symbol, _settingsConfig, _boosterConfig, _compounder, _underlyingAssets4, _poolType);
        ...
        CurveArbiOperations(payable(_ammOperations)).updateWhitelist(address(triCryptoTo2Pool), true);

        return address(triCryptoTo2Pool);
    }
