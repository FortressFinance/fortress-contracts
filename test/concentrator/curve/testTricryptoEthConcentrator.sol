...
contract testTricryptoEthConcentrator is InitTricryptoEthConcentrator, InitETHfrxETH, BaseTest {
    ...
    function setUp() public {
        ...
        address tempAddr = _initializeETHfrxETH(address(fortressRegistry), address(fortressSwap), platform);
        curveCompounder = CurveCompounder(payable(tempAddr)); 
        
        tempAddr = _initTricryptoEthConcentrator(address(fortressRegistry), address(fortressSwap), platform, address(curveCompounder));
