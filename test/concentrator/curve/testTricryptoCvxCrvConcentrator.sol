...
contract testTricryptoCvxCrvConcentrator is InitTricryptoConcentrator, BaseTest {
    ...
    function setUp() public {
        ...
        cvxCrvCompounder = new CvxCrvCompounder(platform, address(fortressSwap));

        address tempAddr = _initTricryptoConcentrator(address(fortressRegistry), address(fortressSwap), platform, address(cvxCrvCompounder));
