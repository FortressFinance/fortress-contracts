...
import {FortressFraxBPOracle} from "src/shared/lending/oracles/FortressFraxBPOracle.sol";

import "test/arbitrum/lending/BaseTest.sol";

contract TestFortressFraxBPOracle is BaseTest {

    FortressFraxBPOracle oracle;
    ...
    function testVaultMaxSpread() public {
        ...
        uint256 _spread = ERC4626(fcFraxBP).convertToAssets(1e18);
