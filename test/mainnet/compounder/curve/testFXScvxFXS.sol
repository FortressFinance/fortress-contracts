...
contract testFXScvxFXS is Test, AddRoutes, CurveCompounderBaseTest {
    ...
    function setUp() public {
        ...
        vm.startPrank(owner);
        // curveCompounder = fortressFactory.launchCurveCompounder(ERC20(cvxFXSFXS_f), "Fortress Curve cvxFXS", "fortress-ccvxFXS", platform, address(fortressSwap), _convexPid, _rewardAssets, _underlyingAssets, _poolType);
