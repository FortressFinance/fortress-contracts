...
//                 (_settings.description, _settings.owner, _settings.platform, _settings.swap, _settings.compounder)
...
//         emit UpdateSettings(_compounder, _platform, _swap, _owner, _depositCap, _underlyingAssets);
//     }
...
//     event UpdateSettings(address compounder, address _platform, address _swap, address _owner, uint256 _depositCap, address[] _underlyingAssets);
