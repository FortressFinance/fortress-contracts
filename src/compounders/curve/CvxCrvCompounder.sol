...
import "src/interfaces/IConvexVirtualBalanceRewardPool.sol";
import "src/interfaces/ICVXMining.sol";
...
contract CvxCrvCompounder is TokenCompounderBase {
    ...
    constructor(address _platform, address _swap) TokenCompounderBase(ERC20(CVXCRV), "Fortress cvxCRV", "fort-cvxCRV", _platform, _swap) {
    ...
    /// @notice See {TokenCompounderBase - totalAssets}
