...
contract AuraBALCompounder is BalancerOperations, TokenCompounderBase {
    ...
    constructor(address _platform, address _swap) TokenCompounderBase(ERC20(AURA_BAL), "Fortress AuraBAL", "fort-auraBAL", _platform, _swap) {
    ...
    function totalAssets() public view override returns (uint256) {
        return IAuraBALRewards(auraBAL_STAKING).balanceOf(address(this));
    }
